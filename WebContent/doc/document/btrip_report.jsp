...
<!-- 전자결재 문서 -->
<form name="form" method="post" action="${root}/" enctype='multipart/form-data' class="mar10b black">
		
		
		<!-- 결재양식 제목 -->
<h1 class="eword_maincolumn">출장 보고서</h1>
...
<td class="pad15l" colspan="3" style="border-top: none;" >
			<span id ="sub_subject">
			<input type="text" id="WordNo" name="WordNo" style="border:0pt;" value="" size='10' readonly />
		</span>
...
<tr class="date" style="height:61px;">
	<!-- 결재 버튼/결재완료 서명 표시 영역 -->
			<td>
							<input type="text"   name="OrderName1" value="이한용" readonly class="form_transparent" style='width:100%;'>
...
<td class="pad15l"  colspan="3" >출장계 &gt; 출장 보고서</td>

				</tr>
				<!-- 부서 -->
				<tr class="eword_meta_height">
					<th style="border-left: none;">부서</th>
<td class="pad15l" colspan="3">경영지원실</td>
...
<td class="pad15l " >사원 이한용</td>

					<!-- 출장인원 -->
											<th>출장인원</th>
						<td class="pad15l">
															<input type="text" id="Business_trip" name="Business_trip" value="" size='1'  />
								명
													</td>
									</tr>
				<!-- 공개여부, 보존기간 -->
