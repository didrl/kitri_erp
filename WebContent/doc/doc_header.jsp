...
<script>
	function golist() {
		 window.open("${root}/organization/list.erp", "select", "top=200, left=300, width=400, height=680, menubar=no, status=no, toolbar=no, location=no, scrollbars=no");
	}
</script>
							...
							<table id="eword_header_part" class="eword_meta">
											...
											<tr class="date" style="height: 61px;">
												...
												<td><input type="text" name="OrderName12" value=""
													...
													<div id="MembersFindCell12" class="btn_page pad15l overf">
														<!-- 지정 -->
														<a  href="${root}/organization/list.erp">
															<span>지정</span>
														</a>
													</div></td>
								...
								<tr class="eword_meta_height">
									...
									<td class="pad15l" colspan="3"><input name="DraftingY"
										type="text" value="" size="4" maxlength="4"> <label>년</label>
										<input name="DraftingM" type="text" value="" size="2"
										maxlength="2"> <label>월</label> <input
										name="DraftingD" type="text" value="" size="2" maxlength="2">
										<label>일</label></td>
								</tr>
								<!-- 기안자, (출장인원) -->
								<tr class="eword_meta_height">
