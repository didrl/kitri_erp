...
<div id="sub">
	...
	<form name="form" method="post" action='prc.php' enctype='multipart/form-data' class="mar10b black">
		...
		<input type="hidden" name="eName"			value="이한용">
		<input type="hidden" name="eTreeKey"		value="0002">
		<input type="hidden" name="eCopLevel"		value="11">
...
<td class="pad15l" colspan="3" style="border-top: none;" >
	...
	<!-- 결재자/협조자 직급 표시 영역 -->
		...
		style="border-top: none;"			>
				<input type="text" name="OrderTitle1" value="사원" readonly class="form_transparent" style='width:100%;line-height:21px;'>
			</td>
		<td 
		style="border-top: none;"			>
				<input type="text" name="OrderTitle2" value="사원" readonly class="form_transparent" style='width:100%;line-height:21px;'>
			</td>
		<td 
		style="border-top: none;"			>
				<input type="text" name="OrderTitle3" value="사원" readonly class="form_transparent" style='width:100%;line-height:21px;'>
			</td>
		<td 
		style="border-top: none;"			>
				<input type="text" name="OrderTitle4" value="팀장" readonly class="form_transparent" style='width:100%;line-height:21px;'>
			</td>
		<td 
		style="border-top: none;"			>
				<input type="text" name="OrderTitle5" value="사원" readonly class="form_transparent" style='width:100%;line-height:21px;'>
			</td>
	</tr>
...
<option label="무기한" value="12000">무기한</option>
		...
		<tr class="change_height_on_print">
			<td id="eword_content" class="pad5">
				<textarea name="editor" id="editor" style="width:100%;height:800px;display:block;">&nbsp;</textarea>
