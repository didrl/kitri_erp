...
<div id="sub">
	...
	<form name="form" method="post" action='prc.php' enctype='multipart/form-data' class="mar10b black">
		...
		<input type="hidden" name="DcsNo"			value="2">
	...
	<!-- 결재양식 제목 -->
<h1 class="eword_maincolumn">품의서</h1>
...
<td class="pad15l" colspan="3" style="border-top: none;" >
	...
	<!-- 결재자/협조자 직급 표시 영역 -->
		...
		<td 
		style="border-top: none;"			>
				<input type="text" name="OrderTitle2" value="상무이사" readonly class="form_transparent" style='width:100%;line-height:21px;'>
			</td>
		<td 
		style="border-top: none;"			>
				<input type="text" name="OrderTitle3" value="대리" readonly class="form_transparent" style='width:100%;line-height:21px;'>
			</td>
		<td 
		style="border-top: none;"			>
				<input type="text" name="OrderTitle4" value="과장" readonly class="form_transparent" style='width:100%;line-height:21px;'>
			</td>
		<td 
		style="border-top: none;"			>
...
<tr class="date" style="height:61px;">
	<!-- 결재 버튼/결재완료 서명 표시 영역 -->
			...
			<td>
							<input type="text"   name="OrderName2" value="김수한" readonly class="form_transparent" style='width:100%;'>
			...
			<td>
							<input type="text"   name="OrderName3" value="이민우" readonly class="form_transparent" style='width:100%;'>
				<input type="hidden" name="OrderId3" value="desk06">
			...
			<td>
							<input type="text"   name="OrderName4" value="김남민" readonly class="form_transparent" style='width:100%;'>
				<input type="hidden" name="OrderId4" value="desk10">
...
<tr class="date" style="height:20px;">
	...
	<!-- 결재자/협조자 직급 표시 영역 -->
		<td 
					>
				<input type="text" name="OrderTitle11" value="소장" readonly class="form_transparent" style='width:100%;line-height:21px;'>
			</td>
		<td 
					>
...
<tr class="date" style="height:61px;">
	<!-- 결재 버튼/결재완료 서명 표시 영역 -->
			<td>
							<input type="text"   name="OrderName11" value="최진성" readonly class="form_transparent" style='width:100%;'>
				<input type="hidden" name="OrderId11" value="desk07">
...
<td class="pad15l"  colspan="3" >품의서</td>
...
<table class="eword_maincolumn eword_meta mar10b">
	...
	<col>
		...
		<th>첨부파일</th>
		<td>
			<textarea rows="10" cols="86" style="height: 100px; overflow: auto;"></textarea>
