...
<!----------------------------------------------------------->
   <!-- Page Content -->
    <div id="page-wrapper">
       ...
       <div class="row">
       		<div class="col-lg-12">
       			<h1 class="page-header" align="left">개인일정</h1>
     		</div>
       	</div>
       	<!--page subject end-->
       	<!--page content start-->
	     	...
	     	<!-- in/out checkbar start -->
	     		<div class="panel panel-default">
				     ...
				     <div class="col-md-4">
					     <div class="panel panel-default">
				     		<div class="panel-body">
						        <div class="tooltip-use" style="margin:auto;">
						        	<button class="btn btn-primary" type="button" onclick="" data-toggle="tooltip" data-placement="top" title="팀장급만 추가 가능">빠른 일정 추가</button>
							       	<button class="btn btn-primary" type="button" onclick="" data-toggle="tooltip" data-placement="top" title="팀장급만 추가 가능">일정 추가</button>
							       	<button class="btn btn-primary" type="button" onclick="" data-toggle="tooltip" data-placement="top" title="팀장급만 추가 가능">인쇄</button>
							     </div>
							     	<br>
					     	</div>  	
			     	  	</div>
